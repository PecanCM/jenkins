...
repo init -u $SYNC_PROTO://github.com/PecanCM/android.git -b $REPO_BRANCH
...
then
  ...
  git commit -a -m "builder: $DEVICE updated on behalf of $INITIATING_OWNER $BUILD_NO: http://builder.pecancm.insomnia247.nl/job/recovery/$BUILD_NO"
