...
repo init -u $SYNC_PROTO://github.com/CyanogenMod/android.git -b $CORE_BRANCH --reference=/usr/local/android/$BUILD_BRANCH
...
WORKSPACE=$WORKSPACE LUNCH=$LUNCH sh $WORKSPACE/jenkins/changes/buildlog.sh 2>&1
